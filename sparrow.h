...
enum { REQUEST_A_IM, REQUEST_ACCEPT, REQUEST_ACCEPT_CHARSET, REQUEST_ACCEPT_DATETIME, REQUEST_ACCEPT_ENCODING, REQUEST_ACCESS_CONTROL_REQUEST_HEADERS, REQUEST_ACCESS_CONTROL_REQUEST_METHOD, REQUEST_AUTHORIZATION, REQUEST_CACHE_CONTROL, REQUEST_CONNECTION, REQUEST_CONTENT_ENCODING, REQUEST_CONTENT_LENGTH, REQUEST_CONTENT_MD5, REQUEST_CONTENT_TYPE, REQUEST_COOKIE, REQUEST_DATE, REQUEST_EXPECT, REQUEST_FOREWARDED, REQUEST_FROM, REQUEST_HOST };
